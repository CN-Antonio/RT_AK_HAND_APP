...
#ifndef __AI_HAND_H__
#define __AI_HAND_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_HAND_MODEL_NAME          "hand"

#define AI_HAND_ACTIVATIONS_ALIGNMENT   (4)

#define AI_HAND_IN_NUM       (1)
#define AI_HAND_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 64, 64, 3, 1, NULL), \
}
#define AI_HAND_IN_SIZE { \
  (64 * 64 * 3), \
}
#define AI_HAND_IN_1_SIZE  (64 * 64 * 3)
#define AI_HAND_IN_1_SIZE_BYTES  ((64 * 64 * 3) * 1)





#define AI_HAND_OUT_NUM      (1)
#define AI_HAND_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 1, 11, 1, NULL), \
}
#define AI_HAND_OUT_SIZE { \
  (1 * 1 * 11), \
}
#define AI_HAND_OUT_1_SIZE  (1 * 1 * 11)
#define AI_HAND_OUT_1_SIZE_BYTES  ((1 * 1 * 11) * 1)

#define AI_HAND_N_NODES (10)
 ...
 * @ref ai_hand_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_HAND_*
 * defines into file @ref hand.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
